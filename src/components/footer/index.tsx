...
import { LinkedinIcon, TelegramIcon, InstagramIcon, ArrowLeftTopIcon, MoveArrowIcon, GitIcon } from "@/styles/icon"
        ...
        <footer className={styles.footer}>
            <Flex gap="8" align="center" justify="space-between" className={styles.footerTop}>
                ...
                <Flex gap="25" align="center" className={styles.footerSocialIconWrap}>
                    <Link aria-label="social" href="https://github.com/JackBabayan" target="_blank" className={styles.footerSocialLink}>
                        <GitIcon />
                    </Link>
